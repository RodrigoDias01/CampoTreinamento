...
public class DSL {
	...
	public void escrever(By by,String texto) {
	  //getDriver().findElement(by).clear(); Limpa todos os pontos antes de nova escrita.
	...
	public Object executarJS(String cmd, Object... param) {
		...
		js.executeAsyncScript(cmd, param);
		return js.executeAsyncScript(cmd, param);
	}
	
	/*********** Tabela **********/
	
	public void clicarBotaoTabela(String colunaBusca, String valor, String colunaBotao, String Coluna) {
